...
require("./data/theme/halloween.js");
    ...
    return (
      <div className="chart-list">
        <div className="title-bar">
          <a href="http://codeffe.com/demo/react-echarts-packet/">
            View On GitHub
          </a>
          <h2>
            <em>React</em> + <i>Echarts</i> = <em>React-Echarts-Packet</em>
          </h2>
        </div>
        ...
        <div className="row">
          <div className="col">
            <div className="box">
              <Echarts option={option} theme={"wonderland"} events={onLineEvents} />
            </div>
          </div>
          <div className="col">
            <div className="box">
              <Echarts {...this.state.options[this.state.index]} />
            </div>
          </div>
          <div className="col">
            <div className="box">
