...
export default class Echarts extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (typeof shouldSetOption === 'function' && !shouldSetOption(prevProps, this.props)) {
      return;
    }
...
Echarts.propTypes = {
  ...
  opts: shape({
    ...
    width: oneOfType([number, oneOf([null, undefined, "auto"])]),
    height: oneOfType([number, oneOf([null, undefined, "auto"])]),
  }),
  notMerge: bool,
  lazyUpdate: bool,
  style: object,
